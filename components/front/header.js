...
const header = () => {
  return (
    <Popover className="relative bg-sky-100 text-white drop-shadow-xl">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group bg-sky-100 rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500'
                    )}
                  >
                    <span>Solutions</span>
                    <ChevronDownIcon
